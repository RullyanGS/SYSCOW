<template>
    <div class="consultaList">
        ...
        <b-row>
            ...
            ref="modal"
            title="Cadastro da Consulta Veterinária"
            size="lg"
            @show="resetModal"
            @hidden="resetModal"
            @ok="cadastroOk">
        ...
        <b-row>
            ...
            ref="modal"
            title="Editar Consulta Veterinária"
            size="lg"
            @show="resetModal"
            @hidden="resetModal"
            @ok="editarOk">
        ...
        <b-row>
            <b-modal
                ...
                title="Excluir Consulta Veterinária" 
                size="lg"
                @ok="remove">
                    <br>
...
import ConsultaHelp from "../help/ConsultaHelp";

export default {
    name: "ConsultaList",
    components: { ConsultaHelp },
